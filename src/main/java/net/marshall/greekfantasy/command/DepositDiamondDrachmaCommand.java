...
public class DepositDiamondDrachmaCommand {

    public DepositDiamondDrachmaCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
    ...
    private int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (player.getMainHandItem().is(ModItems.DIAMOND_DRACHMA.get())) {
