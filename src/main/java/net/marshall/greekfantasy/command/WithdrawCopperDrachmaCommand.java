...
public class WithdrawCopperDrachmaCommand {

    public WithdrawCopperDrachmaCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("money")
                .then(Commands.literal("withdraw")
                .then(Commands.literal("copper_drachma")
