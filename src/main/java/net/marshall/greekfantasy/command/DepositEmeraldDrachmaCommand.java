...
public class DepositEmeraldDrachmaCommand {

    public DepositEmeraldDrachmaCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
    ...
    private int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (player.getMainHandItem().is(ModItems.EMERALD_DRACHMA.get())) {
