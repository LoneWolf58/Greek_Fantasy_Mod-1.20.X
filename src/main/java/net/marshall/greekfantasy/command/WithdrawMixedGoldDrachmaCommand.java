...
public class WithdrawMixedGoldDrachmaCommand {

    public WithdrawMixedGoldDrachmaCommand(CommandDispatcher<CommandSourceStack> dispatcher) {
    ...
    private int execute(CommandContext<CommandSourceStack> context) {
        ...
        } else {context.getSource().sendSuccess(() -> Component.literal("You don't have enough Drachmas to withdraw, you need at least 5 drachmas" ), false);
        } return 1;
    }
}
